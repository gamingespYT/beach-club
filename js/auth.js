//Sistema de autenticación para Beach Club
const AUTH_KEY = 'beachclub_auth';
...
function showLoginModal() {
    ...
    <div id="auth-modal" class="auth-modal">
      <div class="auth-modal-content">
        <div class="auth-header">
          <img src="assets/logo.png" alt="Beach Club" class="auth-logo">
          <h2>🔒 Zona Privada</h2>
  ...
  `;
    ...
    <style>
      ...
      .auth-modal-content {
        background: linear-gradient(135deg, #FF7F50 0%, #87CEEB 100%);
        border-radius: 20px;
        padding: 40px;
        max-width: 450px;
        width: 90%;

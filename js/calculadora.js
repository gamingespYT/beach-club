const products = [
  ...
  { id: 'OR', name: "Oráculo Rosa", price: 40, type: "A" },
  { id: 'AD', name: "Amanecer Dorado", price: 40, type: "A" },
  { id: 'OM', name: "Océano Místico", price: 40, type: "A" },
  { id: 'BL', name: "Bruma Lunar", price: 40, type: "A" },
  { id: 'MS', name: "Marea Serena", price: 40, type: "A" },
  // Bebidas con Alcohol - 60€
  { id: 'TT', name: "Tarot Tonic", price: 60, type: "B" },
  { id: 'AR', name: "El Arcano", price: 60, type: "B" },
  { id: 'EM', name: "Estrella de Mar", price: 60, type: "B" },
  { id: 'LL', name: "Luna Llena", price: 60, type: "B" },
  // Snacks - 40€
  { id: 'DE', name: "Dátiles Encantados", price: 40, type: "C" },
  { id: 'TO', name: "La Tosta del Oráculo", price: 40, type: "C" },
  { id: 'TS', name: "Tempura de Sirena", price: 40, type: "C" },
  { id: 'SA', name: "Tartar de Salmón", price: 40, type: "C" },
  //Weed-Land - 50€
  { id: 'BG', name: "Bong", price: 50, type: "D" }
];
